...
func LogicAlterTableIsExist(v *traverses.TraverseAlterTableIsExist, r *hint.RuleHint) {
...
func LogicAlterTableDropColsOrIndexes(v *traverses.TraverseAlterTableDropColsOrIndexes, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableDropTiDBColWithCoveredIndex(v *traverses.TraverseAlterTableDropTiDBColWithCoveredIndex, r *hint.RuleHint) {
...
func LogicAlterTableOptions(v *traverses.TraverseAlterTableOptions, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
	...
	if v.RowFormat == "DEFAULT" {
		rowFormat, _ = r.KV.Get("innodbDefaultRowFormat")
	}
...
func LogicAlterTableColCharset(v *traverses.TraverseAlterTableColCharset, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddColAfter(v *traverses.TraverseAlterTableAddColAfter, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddColOptions(v *traverses.TraverseAlterTableAddColOptions, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddPrimaryKey(v *traverses.TraverseAlterTableAddPrimaryKey, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddColRepeatDefine(v *traverses.TraverseAlterTableAddColRepeatDefine, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddIndexPrefix(v *traverses.TraverseAlterTableAddIndexPrefix, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddIndexCount(v *traverses.TraverseAlterTableAddIndexCount, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddConstraint(v *traverses.TraverseAlterTableAddConstraint, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddIndexRepeatDefine(v *traverses.TraverseAlterTableAddIndexRepeatDefine, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableRedundantIndexes(v *traverses.TraverseAlterTableRedundantIndexes, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
func LogicAlterTableDisabledIndexes(v *traverses.TraverseAlterTableDisabledIndexes, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableModifyColOptions(v *traverses.TraverseAlterTableModifyColOptions, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableChangeColOptions(v *traverses.TraverseAlterTableChangeColOptions, r *hint.RuleHint) {
	/*
		change操作的2种用法
		修改列的类型信息
...
func LogicAlterTableRenameIndex(v *traverses.TraverseAlterTableRenameIndex, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableRenameTblName(v *traverses.TraverseAlterTableRenameTblName, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableInnodbLargePrefix(v *traverses.TraverseAlterTableInnodbLargePrefix, r *hint.RuleHint) {
	// 获取db表结构
...
func LogicAlterTableInnoDBRowSize(v *traverses.TraverseAlterTableInnoDBRowSize, r *hint.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
