...
type DropTruncateConfig struct {
...
func NewAuditConfiguration() *AuditConfiguration {
	return &AuditConfiguration{
		...
		DropTruncateConfig: DropTruncateConfig{
...
func InitializeAuditConfig(configFile string) (*AuditConfiguration, error) {
	cfg := NewAuditConfiguration()
